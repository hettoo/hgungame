...
class Commands {
    ...
    bool cmdCVarinfo(cClient @client, cString &args, int argc,
            Players @players) {
        GENERIC_CheatVarResponse(client, "cvarinfo", args, argc);
        return true;
    }

    cString @fullUsage(Command @command) {
        return "/" + (command.subCommand ? COMMAND_BASE + " " : "")
            + command.name + " " + command.usage;
    }

    bool handleBase(Command @command, Player @player, cString &args, int argc,
            Players @players) {
    ...
    bool cmdGametype(Command @command, Player @player, cString &args, int argc,
            Players @players) {
        cVar mod("fs_game", "", 0);
    ...
    void cmdRegister(Command @command, Player @player, cString &args,
    ...
    void cmdIdentify(Command @command, Player @player, cString &args,
            int argc, Players @players) {
    ...
    void cmdWhoami(Command @command, Player @player, cString &args,
            int argc, Players @players) {
    ...
    void cmdListplayers(Command @command, Player @player, cString &args,
            int argc, Players @players) {
        Table table;
    ...
    void cmdStats(Command @command, Player @player, cString &args, int argc,
            Players @players) {
        int id;
        if (argc >= 1)
    ...
    void cmdRanking(Command @command, Player @player, cString &args, int argc,
            Players @players) {
        Table table;
    ...
    void cmdHelp(Command @command, Player @player, cString &args, int argc,
            Players @players) {
    ...
    void cmdRestart(Command @command, Player @player, cString &args,
            int argc, Players @players) {
        command.say(player.client.getName() + " is restarting the match");
        exec("match restart");
    }

    void cmdNextmap(Command @command, Player @player, cString &args,
            int argc, Players @players) {
        command.say(player.client.getName() + " is advancing the match");
        exec("match advance");
    }

    void cmdPutteam(Command @command, Player @player, cString &args,
            int argc, Players @players) {
        ...
        if (@other == null) {
            ...
            cString teamName = args.getToken(1);
            int team;
            if (teamName == "alpha") {
                team = TEAM_ALPHA;
    ...
    void cmdShuffle(Command @command, Player @player, cString &args, int argc,
            Players @players) {
    ...
    void cmdKick(Command @command, Player @player, cString &args, int argc,
            Players @players) {
        int id = args.getToken(0).toInt();
        Player @other = players.get(id);
        if (@other == null) {
    ...
    void cmdSetlevel(Command @command, Player @player, cString &args,
            int argc, Players @players) {
        int id = args.getToken(0).toInt();
    ...
    void cmdToggledummies(Command @command, Player @player, cString &args,
            int argc, Players @players) {
    ...
    void cmdLol(Command @command, Player @player, cString &args, int argc,
            Players @players) {
        for (int i = 0; i < players.size; i++) {
            Player @other = players.get(i);
            if (@other != null && @other.client != null
    ...
    void cmdMap(Command @command, Player @player, cString &args, int argc,
            Players @players) {
    ...
    void cmdDevmap(Command @command, Player @player, cString &args,
            int argc, Players @players) {
        cString @map = args.getToken(0);
    ...
    void cmdCVar(Command @command, Player @player, cString &args, int argc,
            Players @players) {
        cString name = args.getToken(0);
        cString cleanName = clean(name);
    ...
    void cmdShutdown(Command @command, Player @player, cString &args,
            int argc, Players @players) {
        command.say(player.client.getName() + " is shutting down the server");
        exec("quit");
    }

    void cmdDo(Command @command, Player @player, cString &args,
            int argc, Players @players) {
    ...
    void cmdUnimplemented(Command @command, Player @player, cString &args,
            int argc, Players @players) {
